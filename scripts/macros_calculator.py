...
def load_effective_parameters():
    ...
    global KETO_CARB_CAP, KETO_PROTEIN_CAP, KETO_FAT_PCT_MIN, HORMONE_CARB_CAP, HORMONE_PROTEIN_CAP, PROTEIN_TOLERANCE_PCT
    mapping = {
...
def cycle_phase(last_period, cycle_len, on_date=None):
    ...
    book-extraction/nutrition-audit/parameter-build-report.md）；未通过时整体降级为单一温和模式，cycle_confidence: low。"""
