...
Chinese Homestyle / The Woks of Life / Chinese Soul Food 三本英文中餐书候选在各自维护区提取目录的 explicit-recipes.jsonl（preliminary_decision=candidate），统一标 Chinese_American_home_cooking，不冒充地方原方。《吃货辞典》《姑苏食话》只产文化/物产/时令索引，explicit_recipe=0。Coconut & Sambal 新版（指纹 158ec08ff63d3f6d）独立进 Southeast_Asian_Indonesian 来源，不参与中餐配额；旧不可用版本不计数。

**正式入池前必须**：人工审维护区提案清单 proposed-new-recipes.jsonl（2026-09-18 重建为 15 条缺口填补提案；原批次 18 条）与 duplicate-merge-plan.json（路径见 developer/maintenance-map.md）（2026-09-18 重建为 20 个同名/同构家族；原批次 16 个）；未批准前不得把新书候选合并进 data/book-recipes.json，也不得用文化散文线索补齐菜谱。

## 2026-09-18 维护区重建批次

原 2026-08-21 批次维护区产物在本机缺失，按本文件流程重新提取：chinese_homestyle 82 / chinese_soul_food 98 / woks_of_life 101 / coconut_sambal 91（候选，状态不变）；新增 how_to_eat_cookbook 75 条候选（fingerprint `4db91cb377f7f119`）与 5×5×5 防御食物清单（《Eat to Beat Disease》附录 A：5 系统 562 条映射、205 项唯一食物，中文化+大陆平替）；chihuo_cidian 144 词条、gusu_shihua 物产 53 + 节令 32 + 文化 307 条。gap-audit.json 记录核心食材缺口 24（high：芝麻酱/饺子皮/豆浆）。仅维护区变更，生产池与 release artifact_hashes 未动。
